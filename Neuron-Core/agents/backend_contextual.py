...
# agents/frontend_contextual.py - FIXED VERSION
...
5. Ensure components work with the detected framework: {structure_summary['frontend']['framework']}
...
"""
    ...
    print(f"[FRONTEND-CONTEXT] Detected framework: {structure_summary['frontend']['framework']}")
